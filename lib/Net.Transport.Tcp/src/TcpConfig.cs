...
namespace VNLib.Net.Transport.Tcp
{
    ...
    public readonly record struct TcpConfig
    {
        ...
        /// before backpressure is applied down to the OS.
        /// </summary>
        public required readonly int MaxConnections { get; init; }
        ...
        /// for optional application specific socket configuration
        /// </summary>
