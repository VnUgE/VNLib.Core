...
* File: FBMClientErrorEventArgs.cs 
*
* FBMClientErrorEventArgs.cs is part of VNLib.Net.Messaging.FBM which is part of the larger 
...
namespace VNLib.Net.Messaging.FBM.Client
{
    ...
    /// </summary>
    public class FBMClientErrorEventArgs : EventArgs
    {
        /// <summary>
